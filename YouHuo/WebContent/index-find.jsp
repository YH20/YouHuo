...
<html>
	...
	<section class="find-pass">
			<div class="find-index">
				<div class="container">
					<div class="find-conta">
						<h1 class="text-center text-danger">忘记密码</h1>
						<div class="form-find">
							<!--用户名-->
							<div class="find-userone">
								<input type="text" name="" id="" value="" placeholder="用户名" class="form-control input-lg input-group find-user" />
							    <p class="findError">此项不能为空 </p>
							    <p class="findError1">用户不存!</p>
							</div>
							<!--密保问题-->
							<div class="find-question">
								<div class="input-group">
									<span class="input-group-addon glyphicon glyphicon-question-sign"></span>
									<select class="form-control input-lg find-pose">
                                        <option class="1">对您影响最大的人名字?</option>
                                        <option class="2">您出生城市名称?</option>
                                        <option class="3">您影响最大的学校名称?</option>
                                        <option class="4">您初中班主任的名字是?</option>
                                        <option class="3"> 您的学号（或工号）是？</option>
                                    </select>
								</div>
								<div class="input-group">
									<span class="input-group-addon glyphicon glyphicon-pencil"></span>
									<input type="text" class="form-control input-lg find-answer" placeholder="答案">
								    <p class="find-answerError">请您填写！</p>
									<p class="find-answerError1">请您填写正确答案!</p>
								</div>
							</div>
							...
							<div class="input-group">
								...
								<input type="text" name="" id="" value="" class="form-control find-messge input-lg" placeholder="验证码" />
								<a class="btn input-group-btn"><input type="button" name="" id="find-random" value="" class="btn btn-block" /></a>
							    <p class="findError1">请输入验证码！</p>
							    <p class="findError2">验证码错误！</p>
							</div>
							<a href="javascript:;" class="btn btn-block btn-lg find-btn">下一步</a>
							<h5 class="text-right"><a href=" index-login.html" class="retruelog" >返回登录</a></h5>
						</div>
					</div>
				</div>
			</div>
