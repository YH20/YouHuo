	...
	<body>
		...
		<section class="reset">
			<div class="reset-index">
				<div class="container">
					<div class="reset-conta">
						<h1 class="text-center text-danger">重置密码</h1>
						<div class="form-reset">
							<!--用户名-->
							<div class="reset-userone ">
								<input type="text" readonly="true" name="" id="" value="" placeholder="" class="form-control input-lg  input-group reset-user" />
							</div>
							<!--密码-->
							<div class="reset-question">
								<div class="input-group">
									<span class="input-group-addon glyphicon glyphicon-lock "></span>
									<input type="text" name="" id="" value="" placeholder="新密码" class="form-control input-lg reset-pass" />
								    <p class="resetError">此项不能为空</p>
								    <p class="resetError1">密码必须在6-30个字符之间 </p>
								    <p class="resetError2">密码不允许有空格 </p>
								    <p class="resetError3">两次密码输入不一致</p>
								</div>
								<div class="input-group">
									<span class="input-group-addon glyphicon glyphicon-lock "></span>
									<input type="text" class="form-control input-lg reset-pass1" placeholder="重复密码">
								    <p class="reset1Error">此项不能为空 </p>
								    <p class="reset1Error2">两次密码输入不一致</p>
								</div>
							</div>
							<a href="javascript:;" class="btn btn-block btn-lg reset-btn">重置密码</a>
