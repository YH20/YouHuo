					...
					<div class="register-conta">
						<div class="form-register">
							...
							<div class="input-group">
								...
								<input type="text" name="" id="" value="" class="form-control form-user input-lg" placeholder="用户名" aria-describedby="sizing-addon1" />
							...
							<div class="input-group">
								...
								<input type="password" name="" id="" value="" class="form-control form-pass input-lg" placeholder="密码" />
							...
							<div class="register-question">
								<div class="input-group">
									...
									<select class="form-control input-lg rgister-pose">
                                        <option class="0">请设置密保问题?</option>
                                        <option class="1">对您影响对大的人名字?</option>
								...
								<div class="input-group register-answer">
									...
									<input type="text" class="form-control input-lg reg-input-answer" placeholder="输入密保答案">
							...
							<div class="input-group">
								...
								<input type="text" name="" id="" value="" class="form-control form-messge input-lg" placeholder="验证码" />
								<a class="btn input-group-btn"><input type="button" name="" id="register-random" value="" class="btn btn-block" /></a>
								<p class="mesError"><img src="img/eer.png"/>此项不能为空</p>
								<p class="mes1Error"><img src="img/eer.png"/>验证码错误!</p>
							</div>
							<button class="btn btn-block register-btn btn-lg">立即注册</button>
